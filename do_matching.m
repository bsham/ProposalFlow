...
% written by Minsu Cho, modified by Bumsub Ham, Inria - WILLOW / ENS, Paris, France

function do_matching(db_name)
            ...
            for j=1:nImage
                ...
                for fa = 1:numel(conf.algorithm)
                    ...
                    if bShowMatch
                        ...
                        fprintf(' # of matches at threshold %.2f: %d\n\n',IoU_threshold, nnz(id_true));
